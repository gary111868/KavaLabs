...
#[derive(Debug)]
pub struct KavaLabsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KavaLabsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KavaLabs processing");
    
    let mut processor = KavaLabsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KavaLabsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KavaLabsProcessor::new(false);
